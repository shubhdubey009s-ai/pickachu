        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <h2 className="text-4xl md:text-5xl font-bold">
              Meet Your <span className="text-yellow-400">Coach Aditya</span>
            </h2>

            {/* About Description */}
            <p className="text-lg text-gray-100 leading-relaxed font-medium">
              Coach Aditya is a certified fitness expert specializing in
              bodybuilding, athlete training, and lifestyle transformation. He
              has helped professionals, athletes, and fitness enthusiasts
              achieve their peak performance without compromising balance or
              energy.
            </p>

            {/* Credentials Section */}
            <div className="bg-white/15 backdrop-blur-md rounded-2xl p-6 border border-yellow-500/30 shadow-lg shadow-black/50">
              ...
              <ul className="space-y-3">
                {certifications.map((cert, index) => (
                  <li key={index} className="flex items-center space-x-3">
                    ...
                    <span className="text-gray-100 font-medium">{cert.name}</span>
                  </li>
                ))}
              </ul>
            </div>
